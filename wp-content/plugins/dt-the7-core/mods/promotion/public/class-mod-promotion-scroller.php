...
if ( ! class_exists( 'Presscore_Promotion_Posts_Scroller', false ) ) {

	class Presscore_Promotion_Posts_Scroller extends Presscore_Posts_Slider_Scroller {

		protected function setup_config() {
			$config = presscore_get_config();

			$config->set( 'is_scroller', true );
			$config->set( 'template', 'promotion' );
