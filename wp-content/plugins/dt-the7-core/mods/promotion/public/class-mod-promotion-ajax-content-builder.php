<?php
/**
 * Promotion ajax content builder.
 */

// File Security Check
if ( ! defined( 'ABSPATH' ) ) { exit; }

class Presscore_Mod_Promotion_Ajax_Content_Builder extends Presscore_Ajax_Content_Builder {

	protected function configure_template() {
		$this->config->set( 'template', 'promotion' );
	...
	protected function custom_loop() {
		...
		$page_query = presscore_get_filtered_posts( array( 'post_type' => 'dt_promotion', 'taxonomy' => 'dt_promotion_category' ) );
			...
			while( $page_query->have_posts() ) { $page_query->the_post();
				...
				switch ( $page_layout ) {
					...
					case 'list':
						...
						presscore_get_template_part( 'mod_promotion', 'list/project' );
						break;
				}
