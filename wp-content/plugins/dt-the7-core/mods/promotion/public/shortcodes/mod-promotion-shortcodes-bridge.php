<?php
/**
 * Promotion shortcodes VC bridge.
 *
 * @package the7\Promotion\Shortcodes
 * @since 3.0.0
 */
...
vc_map( array(
	"weight"	=> -1,
	"base"		=> "dt_promotion_slider",
	"name"		=> __("Promotion Scroller", 'the7mk2'),
	"category"	=> __('by Dream-Theme', 'the7mk2'),
	"icon"		=> "dt_vc_ico_promotion_slider",
	"class"		=> "dt_vc_sc_promotion_slider",
	"params"	=> array(
		// General group.
		$category,
		$number_order_title,
...
vc_map( array(
	"weight"	=> -1,
	"base"		=> "dt_promotion",
	"name"		=> __( "Promotion Masonry & Grid", 'the7mk2' ),
	"category"	=> __( 'by Dream-Theme', 'the7mk2' ),
	"icon"		=> "dt_vc_ico_promotion",
	"class"		=> "dt_vc_sc_promotion",
	"params"	=> array(
		// General group.
		$category,
		$number_order_title,
...
/**
 * Promotion justified grid.
 */

vc_map( array(
	"weight"	=> -1,
	"base"		=> 'dt_promotion_jgrid',
	"name"		=> __( "Promotion Justified Grid", 'the7mk2' ),
	"category"	=> __( 'by Dream-Theme', 'the7mk2' ),
	"icon"		=> "dt_vc_ico_promotion",
	"class"		=> "dt_vc_sc_promotion",
	"params"	=> array(
