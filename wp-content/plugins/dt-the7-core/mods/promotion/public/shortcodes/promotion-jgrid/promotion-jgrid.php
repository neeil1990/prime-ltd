<?php
/**
 * Promotion justified grid shortcode.
 *
 */
...
if ( ! class_exists( 'DT_Shortcode_Promotion_Jgrid', false ) ) {

	class DT_Shortcode_Promotion_Jgrid extends DT_Masonry_Posts_Shortcode {

		protected $shortcode_name = 'dt_promotion_jgrid';
		...
		public function shortcode( $atts, $content = null ) {
			...
			if ( $this->vc_is_inline ) {
				...
				return $this->vc_inline_dummy( array(
					'class' => 'dt_vc-promotion_jgrid',
					'title' => _x( 'Promotion Justified Grid', 'vc inline dummy', 'the7mk2' ),
					'fields' => array(
		...
		protected function shortcode_html() {
			...
			if ( $dt_query->have_posts() ) {
				...
				$output = $this->the_loop( array(
					'masonry_container_class' => array( 'wf-container', 'dt-promotion-shortcode', 'jgrid-shortcode' ),
	...
	add_shortcode( 'dt_promotion_jgrid', array( new DT_Shortcode_Promotion_Jgrid(), 'shortcode' ) );
}
