...
if ( ! class_exists( 'DT_Shortcode_Promotion', false ) ) {

	class DT_Shortcode_Promotion extends DT_Masonry_Posts_Shortcode {

		protected $shortcode_name = 'dt_promotion';
		...
		public function shortcode( $atts, $content = null ) {
			...
			if ( $this->vc_is_inline ) {
				...
				return $this->vc_inline_dummy( array(
					'class' => 'dt_vc-promotion_masonry',
					'title' => _x( 'Promotion Masonry & Grid', 'vc inline dummy', 'the7mk2' ),
					'fields' => array(
		...
		protected function shortcode_html() {
			...
			if ( $dt_query->have_posts() ) {
				...
				$loop_args = array(
					'masonry_container_class' => array( 'wf-container', 'dt-promotion-shortcode' ),
	...
	add_shortcode( 'dt_promotion', array( new DT_Shortcode_Promotion(), 'shortcode' ) );
}
