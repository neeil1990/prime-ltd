<?php
/**
 * Promotion project single post template
 *
 * @package vogue
 * @since 1.0.0
 */
...
include plugin_dir_path( __FILE__ ) . 'promotion-post-single-media.php';
	...
	case 'before':
		...
		echo '<div class="wf-container">';
			echo '<div class="wf-cell wf-1 project-content">';
				the_content();
				include plugin_dir_path( __FILE__ ) . 'promotion-post-single-links.php';
			echo '</div>';
		echo '</div>';
		break;
