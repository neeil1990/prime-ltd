 ...
 * Heading definition.
 */
$new_options[] = array( "name" => _x("Promotion post", "theme-options", 'the7mk2'), "type" => "heading" );
	...
	$new_options[] = array(	"name" => _x('Previous &amp; next buttons', 'theme-options', 'the7mk2'), "type" => "block_begin" );
		...
		// radio
		$new_options[] = array(
			"name"      => _x( 'Show in promotion posts', 'theme-options', 'the7mk2' ),
			"id"    	=> 'general-next_prev_in_promotion',
			'type'		=> 'images',
			'class'     => 'small',
			'std'   	=> 1,
			'options'	=> array(
	...
	$new_options[] = array(	"name" => _x('Meta information', 'theme-options', 'the7mk2'), "type" => "block_begin" );
		...
		$new_options[] = array( 'type' => 'js_hide_begin' );
			...
			$new_options[] = array(
				...
				"id"    	=> 'general-promotion_meta_date',
				"type"  	=> 'checkbox',
				'std'   	=> 1
			);
			...
			$new_options[] = array(
				...
				"id"    	=> 'general-promotion_meta_author',
				"type"  	=> 'checkbox',
				'std'   	=> 1
			);
			...
			$new_options[] = array(
				...
				"id"    	=> 'general-promotion_meta_categories',
				"type"  	=> 'checkbox',
				'std'   	=> 1
			);
			...
			$new_options[] = array(
				...
				"id"    	=> 'general-promotion_meta_comments',
				"type"  	=> 'checkbox',
				'std'   	=> 1
			);
...
// add new options
if ( isset( $options ) ) {
	$options = dt_array_push_after( $options, $new_options, 'blog_and_promotion_placeholder' );
}
