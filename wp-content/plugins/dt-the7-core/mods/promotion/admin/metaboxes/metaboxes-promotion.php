<?php
/**
 * Promotion template and post meta boxes
 *
 * @package vogue
 * @since 1.0.0
 */
...
$prefix = '_dt_promotion_';

$DT_META_BOXES[] = array(
	'id'		=> 'dt_page_box-display_promotion',
	'title' 	=> _x('Display Promotion Category(s)', 'backend metabox', 'the7mk2'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			...
			'main_tab_class'	=> 'dt_all_promotion',
			'desc'				=> sprintf(
				...
				_x('ALL your Promotion projects are being displayed on this page!', 'backend', 'the7mk2'),
				_x('By default all your Promotion projects will be displayed on this page. ', 'backend', 'the7mk2'),
				_x('But you can specify which Promotion project category(s) will (or will not) be shown.', 'backend', 'the7mk2'),
	...
	'only_on'	=> array( 'template' => array('template-promotion-list.php', 'template-promotion-masonry.php', 'template-promotion-jgrid.php') ),
);

/***********************************************************/
// Promotion template options
/***********************************************************/

$prefix = '_dt_promotion_options_';

$DT_META_BOXES[] = array(
	'id'		=> 'dt_page_box-promotion_options',
	'title' 	=> _x('Promotion Options', 'backend metabox', 'the7mk2'),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'list layout', array( 'id' => "{$prefix}list_layout", 'show_on_template' => 'template-promotion-list.php' ) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'background under post', array(
			...
			'divider'			=> 'top',
			'show_on_template'	=> 'template-promotion-list.php'
		) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'masonry layout', array( 'id' => "{$prefix}masonry_layout", 'divider' => 'bottom', 'show_on_template' => 'template-promotion-masonry.php' ) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'gap between images', array(
			...
			'divider'			=> false,
			'show_on_template'	=> array( 'template-promotion-masonry.php', 'template-promotion-jgrid.php' )
		) ),

		// Row target height
		Presscore_Meta_Box_Field_Template::get_as_array( 'row target height', array( 'id' => "{$prefix}target_height", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Column target width
		Presscore_Meta_Box_Field_Template::get_as_array( 'column target width', array( 'id' => "{$prefix}target_width", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// Columns number
		Presscore_Meta_Box_Field_Template::get_as_array( 'columns number', array( 'id' => "{$prefix}columns_number", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// 100% width
		Presscore_Meta_Box_Field_Template::get_as_array( '100 percent width', array( 'id' => "{$prefix}full_width", 'show_on_template' => array( 'template-promotion-jgrid.php', 'template-promotion-masonry.php' ) ) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'description style', array(
			...
			'show_on_template'	=> 'template-promotion-masonry.php'
		) ),

		// Hover animation
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover animation', array( 'id' => "{$prefix}hover_animation", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// Hover background color
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover background color', array( 'id' => "{$prefix}hover_bg_color", 'show_on_template' => 'template-promotion-masonry.php' ) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover content visibility', array( 'id' => "{$prefix}hover_content_visibility", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// Content alignment
		Presscore_Meta_Box_Field_Template::get_as_array( 'content alignment', array( 'id' => "{$prefix}post_content_alignment", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// Vertical left ontent alignment
		Presscore_Meta_Box_Field_Template::get_as_array( 'vertical left content alignment', array( 'id' => "{$prefix}bg_post_content_alignment", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// Animation effect
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover lines animation', array( 'id' => "{$prefix}lines_animation_effect", 'show_on_template' => 'template-promotion-masonry.php' ) ),

		// Title visibility
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover content visibility', array( 'id' => "{$prefix}title_visibility", 'name' => _x( 'Title visibility:', 'backend metabox', 'the7mk2' ), 'show_on_template' => 'template-promotion-masonry.php' ) ),
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'jgrid description style', array(
			...
			'show_on_template'	=> 'template-promotion-jgrid.php'
		) ),

		// Hover animation
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover animation', array( 'id' => "{$prefix}jgrid_hover_animation", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Hover background color
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover background color', array( 'id' => "{$prefix}jgrid_hover_bg_color", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Hover content visibility
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover content visibility', array( 'id' => "{$prefix}jgrid_hover_content_visibility", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Vertical left ontent alignment
		Presscore_Meta_Box_Field_Template::get_as_array( 'vertical left content alignment', array( 'id' => "{$prefix}jgrid_bg_post_content_alignment", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Content alignment
		Presscore_Meta_Box_Field_Template::get_as_array( 'content alignment', array( 'id' => "{$prefix}jgrid_post_content_alignment", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Animation effect
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover lines animation', array( 'id' => "{$prefix}jgrid_lines_animation_effect", 'show_on_template' => 'template-promotion-jgrid.php' ) ),

		// Title visibility
		Presscore_Meta_Box_Field_Template::get_as_array( 'hover content visibility', array( 'id' => "{$prefix}jgrid_title_visibility", 'name' => _x( 'Title visibility:', 'backend metabox', 'the7mk2' ), 'show_on_template' => 'template-promotion-jgrid.php' ) ),
		...
		// Hide last row
		Presscore_Meta_Box_Field_Template::get_as_array( 'hide last row', array( 'id' => "{$prefix}hide_last_row", 'show_on_template' => 'template-promotion-jgrid.php' ) ),
		...
		// Media content width
		Presscore_Meta_Box_Field_Template::get_as_array( 'media content width', array( 'id' => "{$prefix}thumb_width", 'show_on_template' => 'template-promotion-list.php' ) ),
		...
		// Loading effect
		Presscore_Meta_Box_Field_Template::get_as_array( 'loading effect', array( 'id' => "{$prefix}load_effect", 'show_on_template' => array( 'template-promotion-jgrid.php', 'template-promotion-masonry.php' ) ) ),
		...
		array(
			'before'	=> presscore_meta_boxes_advanced_settings_tpl('dt_promotion-advanced'), // advanced settings
		...
		// details button
		array(
			'before'	=> '<div class="rwmb-hidden-field hide-if-js" data-show-on="template-promotion-list.php">',
			'top_divider'	=> true,
...
/***********************************************************/
// Promotion post media options
/***********************************************************/

$prefix = '_dt_project_media_options_';

$DT_META_BOXES[] = array(
	'id'		=> 'dt_page_box-promotion_post_media_options',
	...
	'fields' 	=> array(
		...
		// Slider Scale Mode
		array(
			'name'           => _x('Scale Mode:', 'backend metabox', 'the7mk2'),
			'id'             => "{$prefix}scale_mode",
			'type'           => 'radio',
			'std'            =>'fill',
			'options'        => array(
				'fill' => _x('fill', 'backend metabox', 'the7mk2'),
				'fit' => _x('fit', 'backend metabox', 'the7mk2'),
			),
			'top_divider'    => true,
...
/***********************************************************/
// Promotion post options
/***********************************************************/

$prefix = '_dt_project_options_';

$DT_META_BOXES[] = array(
	'id'		=> 'dt_page_box-promotion_post',
	...
	'fields' 	=> array(
		...
		array(
			...
			'before'	=> '<p><small>' . sprintf(
				_x('Related projects can be enabled / disabled from %sTheme Options / Blog, Promotion, Gallery%s', 'backend metabox', 'the7mk2'),
				'<a href="' . esc_url( add_query_arg( 'page', 'of-blog-and-promotion-menu', get_admin_url() . 'admin.php' ) ) . '" target="_blank">',
				'</a>'
