<?php
	function get_server_response_time($url){
		if(function_exists("curl_init")){
		    ...
		    $file      = @fsockopen($url, 443, $errno, $errstr, 10);
	...
	$wpfc_servers = array("de" => array("time" => get_server_response_time("https://api.wpfastestcache.net"),
						  ...
						  "ny" => array("time" => get_server_response_time("https://api.wpfcny.tk"),
										"flag" => "us",
										"location" => "NY",
										"color" => "red"),

						  "pl" => array("time" => get_server_response_time("https://api.wpfcpl.tk"),
										"flag" => "pl",
										"location" => "Poland",
										"color" => "red"),
						  ...
						  "sg" => array("time" => get_server_response_time("https://api.wpfcsg.tk"),
					 	  ...
					 	  "tx" => array("time" => get_server_response_time("https://api.wpfastestcache.in"),
										...
										"location" => "TX",
										"color" => "red"),
					 	  "dl" => array("time" => get_server_response_time("https://api.wpfcdallas.tk"),
										"flag" => "us",
										"location" => "Dallas",
										"color" => "red"),
