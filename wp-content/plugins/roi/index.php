...
define('U_DIR', plugin_dir_path(__FILE__));
define('U_URL', plugin_dir_url(__FILE__));

function index_roi(){

    ?>
    <link rel="stylesheet" href="<?=U_URL?>css/bootstrap.min.css">
    <link rel="stylesheet" href="<?=U_URL?>css/AdminLTE.css">
    <link rel="stylesheet" href="<?=U_URL?>css/style.css">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?=U_URL?>js/jQuery-2.1.4.min.js"></script>
    <!-- Calc -->
    <script src="<?=U_URL?>js/calc.js"></script>
    <?
}

add_shortcode( "roi" , "index_roi" );
