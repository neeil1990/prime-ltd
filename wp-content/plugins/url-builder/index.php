...
function index_b(){
	?>
<link rel='stylesheet' id='swpc-main-css'  href='<?=plugin_dir_url(__FILE__);?>css/style.css' type='text/css' media='all' />
            ...
            <div class="urlBuilder_form">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="urlBuilder_el">
                            <div class="btn btn-primary urlBuilder_go">Создать URL</div>
                ...
                <div class="hide">
                    <div class="urlBuilder_result">
                        ...
                        <div class="urlBuilder_result_buttons">
                            <span class="btn swpmodal-close">Закрыть</span>
                        </div>
                    </div>
                </div>
...
<script type='text/javascript' src='<?=plugin_dir_url(__FILE__);?>js/url-builder.min.js'></script>
...
add_shortcode( "url-builder" , "index_b" );
